...
import { Heart, ShoppingCart, Star, Grid, List, Search, Award, Filter } from "lucide-react";
...
const Grains = () => {
  ...
  // Mock data fallback
  const fallbackGrains = [
    {
      id: 1,
      name: "Gạo ST25 hảo hạng",
      price: 45000,
      originalPrice: 50000,
      images: ["https://images.unsplash.com/photo-1586201375761-83865001e31c?w=300"],
      rating: 4.9,
      reviewCount: 234,
      sellerName: "Gạo Việt Nam",
      description: "Gạo ST25 đạt giải thưởng gạo ngon nhất thế giới",
      specifications: { 'Xuất xứ': 'An Giang', 'Premium': 'Có' }
    },
    {
      id: 2,
      name: "Gạo tám xoan An Giang",
      price: 38000,
      originalPrice: null,
      images: ["https://images.unsplash.com/photo-1596797038530-2c107229654b?w=300"],
      rating: 4.7,
      reviewCount: 189,
      sellerName: "Nông trại An Giang",
      description: "Gạo tám xoan thơm dẻo truyền thống",
      specifications: { 'Xuất xứ': 'An Giang' }
    },
    {
      id: 3,
      name: "Gạo nàng hương Cần Thơ",
      price: 42000,
      originalPrice: 47000,
      images: ["https://images.unsplash.com/photo-1574323347407-f5e1ad6d020b?w=300"],
      rating: 4.8,
      reviewCount: 156,
      sellerName: "Coop Cần Thơ",
      description: "Gạo nàng hương mềm dẻo, thơm tự nhiên",
      specifications: { 'Xuất xứ': 'Cần Thơ' }
    },
    {
      id: 4,
      name: "Gạo lứt hữu cơ",
      price: 55000,
      originalPrice: null,
      images: ["https://images.unsplash.com/photo-1589481169991-45d486dd2874?w=300"],
      rating: 4.6,
      reviewCount: 98,
      sellerName: "Nông trại Organic",
      description: "Gạo lứt hữu cơ giàu chất xơ và vitamin",
      specifications: { 'Xuất xứ': 'Việt Nam', 'Premium': 'Có' }
    },
    {
      id: 5,
      name: "Gạo tẻ thường",
      price: 32000,
      originalPrice: 35000,
      images: ["https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300"],
      rating: 4.4,
      reviewCount: 267,
      sellerName: "Nông nghiệp Đồng bằng",
      description: "Gạo tẻ thường chất lượng tốt cho bữa cơm gia đình",
      specifications: { 'Xuất xứ': 'Việt Nam' }
    },
    {
      id: 6,
      name: "Gạo jasmine thái lan",
      price: 48000,
      originalPrice: null,
      images: ["https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=300"],
      rating: 4.7,
      reviewCount: 143,
      sellerName: "Nhập khẩu Á Châu",
      description: "Gạo jasmine thơm đặc trưng từ Thái Lan",
      specifications: { 'Xuất xứ': 'Thái Lan', 'Premium': 'Có' }
    }
  ];
  ...
  useEffect(() => {
    const loadProducts = async () => {
      try {
        ...
        // Filter only grains using consistent category matcher
        const grainProducts = allProducts.filter(product => 
          isProductInCategory(product.category, 'Ngũ cốc')
        );
        
        if (grainProducts.length > 0) {
          setProducts(grainProducts);
          setFilteredProducts(grainProducts);
        } else {
          setProducts(fallbackGrains as any);
          setFilteredProducts(fallbackGrains as any);
        }
      } catch (error) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Ngũ cốc & Gạo</h1>
          <p className="text-muted-foreground">
            Gạo và ngũ cốc chất lượng cao từ các vùng trồng trọt nổi tiếng Việt Nam
          </p>
        </div>
                      ...
                      <div className={`flex ${viewMode === "list" ? "flex-row" : "flex-col"}`}>
                        ...
                        <div className={`relative bg-gradient-to-br from-primary/5 to-accent/5 flex items-center justify-center ${
                          ...
                          <div className="absolute top-4 left-4 space-y-2">
                            ...
                            {product.specifications?.['Premium'] && (
